...
content = content.replace(
	...
	'<div class="col-12 col-md-3 d-flex flex-column left-col border-end border-secondary">'
);

// Update mid column
content = content.replace(
	'<div class="column mid-col" style="width: {midColWidth}px;">',
	'<div class="col-12 col-md-4 d-flex flex-column mid-col border-end border-secondary">'
);

// Update right column
content = content.replace(
	'<div class="column right-col printable-area">',
	'<div class="col-12 col-md-5 d-flex flex-column right-col printable-area h-100">'
);
